...
#define jx_fmax(a,b) ((a)>(b)?(a):(b))
#define jx_fmin(a,b) ((a)<(b)?(a):(b))
...
struct cRect
{
	...
	{
		return cRect(jx_fmax(rect.l,l),jx_fmax(rect.t,t),jx_fmin(rect.r,r),jx_fmin(rect.b,b));
	}

	cRect operator | (cRect &rect)
	{
		return cRect(jx_fmin(rect.l,l),jx_fmin(rect.t,t),jx_fmax(rect.r,r),jx_fmax(rect.b,b));
	}
