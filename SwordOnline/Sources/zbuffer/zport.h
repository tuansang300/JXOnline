...
// ==========================================================================
// Platform-independent debug macros (ASSERT, VERIFY, TRACE)
...
// Platform-independent utility macros (defined early for WIN32)
#ifndef SAFE_DELETE
...
// Platform-independent utility macros
#ifndef SAFE_DELETE
#define SAFE_DELETE(x)			try{ if( (x) != NULL ) { delete (x); (x) = NULL; } } catch(...) { }
#endif
#ifndef SAFE_DELETE_ARRAY
#define SAFE_DELETE_ARRAY(x)	try{ if( (x) != NULL ) { delete[] (x); (x) = NULL; } } catch(...) { }
#endif
#ifndef SAFE_FREE
#define SAFE_FREE(x)			try{ if( (x) != NULL ) { free(x); (x)=NULL; } } catch(...) { }
#endif
#ifndef SAFE_RELEASE
#define SAFE_RELEASE(x)			try{ if( (x) != NULL ) { (x)->Release(); (x) = NULL; } } catch(...) { }
#endif
//��װ�Ļ�������
class ZMutex {
#ifdef WIN32
...
private:
	...
	static void operator delete( void *pObj ) { ::operator delete(pObj); }
